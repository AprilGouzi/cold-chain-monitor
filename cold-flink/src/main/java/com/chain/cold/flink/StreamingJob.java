...
public class StreamingJob {
    public static void main(String[] args) throws Exception{
        ...
        properties.setProperty("bootstrap.servers","192.168.198.136:9092");
        ...
        FlinkKafkaProducer<String> myProducer = new FlinkKafkaProducer<>("all_device_message",new SimpleStringSchema(),properties);
